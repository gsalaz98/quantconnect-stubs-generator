...
namespace QuantConnectStubsGenerator.Parser
{
        ...
        where T : ILanguageType<T>
    {
        ...
        /// </summary>
        T GetType(SyntaxNode node, bool skipPythonTypeCheck = false);

        /// <summary>
        /// Returns the Python type of the given symbol.
        /// Returns an aliased typing.Any if there is no Python type for the given symbol.
        /// </summary>
        T GetType(ISymbol symbol, bool skipPythonTypeCheck = false);
        ...
        /// </summary>
        T TypeToTargetLanguageType(T type, bool skipPythonTypeCheck = false);
    }
}
